        ...
        <div class="main-top py-1">
            <nav class="navbar navbar-expand-lg navbar-light fixed-navi">
                <div class="container">
                    <!-- logo -->
                    <h1>
                        <img src="images\logo2 (2).png" style="height:150px; width:150px; margin:-45px;">
                        <a class="navbar-brand font-weight-bold font-italic" href="index.php" style="margin-left:-100px;">
